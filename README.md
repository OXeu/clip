...
<!-- clip-ui-screenshots: run=35599946018; commit=27e6bdd10e2a3733e41829de81ad28a3de45aeab; size=3024x2043; density=3x -->
<picture>
...
- 导入后自动分离视频轨与音频轨，音频以真实波形显示；单个视频可添加多条 BGM/伴声音轨，并分别调节素材与轨道音量、片段倍速和 ±12 半音变调。
- 分割、删除、拖拽排序，支持撤销与重做。
