...
internal static class UiTheme
{
    ...
    [
        ...
        ("ColorBrandBackground", "#AC3863", "#F2A0BD"),
        ("ColorBrandBackgroundHover", "#962C54", "#F6B4CB"),
        ("ColorBrandBackgroundPressed", "#802247", "#E689AA"),
        ("ColorBrandBackground2", "#FCEEF3", "#302029"),
        ("ColorBrandForeground", "#A1325A", "#F2A0BD"),
        ("ColorBrandStroke", "#D66B94", "#D66B94"),
        ("ColorOnBrand", "#FFFFFF", "#26141D"),
